...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"light blue\">" + qVolume + " BDT" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " BDT" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " BDT");
    }
