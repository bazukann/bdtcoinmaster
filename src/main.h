...
#define FOUNDATION "BHie6NjGBWFRpxPLwPbg5K8NCv8c1SJuRV"

#define FOUNDATION_TEST "BHie6NjGBWFRpxPLwPbg5K8NCv8c1SJuRV"
...
public:
    ...
    {
        // bdtcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // bdtcoin: get transaction coin age
...
public:
    ...
    // bdtcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // bdtcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // bdtcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // bdtcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // bdtcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // bdtcoin: block index flags
    enum  
    {
